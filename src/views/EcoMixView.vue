    ...
    <section>
      <div class="eco-mix-view-content-selection-periode">
        <div class="eco-mix-view-content-selection-periode-start">
          <p>Début</p>
          <Datepicker v-model="pickedStart" :upper-limit="limitDateStart" />
        </div>
        <div class="eco-mix-view-content-selection-periode-end">
          <p>Fin</p>
          <Datepicker v-model="pickedEnd" :upper-limit="limitDateEnd" />
        </div>
      </div>
    </section>
  </div>
...
const limitDateStart = new Date(LIMIT_DATE_DATA);
const pickedStart = ref(limitDateStart);

const limitDateEnd = new Date(LIMIT_DATE_DATA);
const pickedEnd = ref(limitDateEnd);
</script>
